...
<style>
    ...
    /* Dropdown menu: handled by global popover rules below */
    /* Global popover dropdown fix — white bg + dark text (Streamlit renders popovers at body level) */
